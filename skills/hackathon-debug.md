...
2. **Reproduce**: Run steps. Fails? -> Continue. Passes 3x? -> Remove `in-progress`, label `needs-human-review`. Unassign. Comment: "agent: cannot reproduce - steps passed 3x". Return to `hackathon-session`.
